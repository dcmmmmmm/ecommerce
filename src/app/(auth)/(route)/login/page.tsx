...
export default function LoginPage() {
  ...
  return(
    <div className='bg-gradient-to-r from-[#D3E7EE] to-[#ABD1DC] min-h-screen flex items-center justify-center'>
      <div className='bg-white flex rounded-2xl shadow-lg shadow-white max-w-3xl p-5'>
        ...
        <Card className='sm:w-1/2 border-none  rounded-2xl '>
          <CardHeader>
            ...
            <CardDescription className='text-black'>Enter your details to sign in.</CardDescription>
          </CardHeader>
          <Separator/>
          <CardContent> 
            ...
            <Button onClick={() => signIn('google', {callbackUrl: '/'})} size="lg"  color="blue-gray" className="mt-5 py-2 w-full bg-gray-300 text-black rounded-xl hover:bg-gray-200" >
                <Image src='/google-symbol.png' width={20} height={20} alt="GOOGLE" className='mr-4'/>
                Continue with Google
              </Button>
              <div className='p-2'></div>
              <Button onClick={() => signIn('github', {callbackUrl: '/'})} size="lg"  color="blue-gray" className=" py-2 w-full bg-black text-white rounded-xl hover:bg-gray-700" >
                <Image src='/github.png' width={20} height={20} alt="GITHUB" className='mr-4 bg-white rounded-full'/>
                Continue with Github
              </Button>
          </CardContent>
        </Card>
        <div className='sm:block hidden w-1/2  '>
          <Image src={'/loginphoto.png'} alt='' width={500} height={500} className='ml-2 mt-5 rounded-2xl'/>
        </div>
      </div>
